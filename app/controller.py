...
con.execute('CREATE VIEW IF NOT EXISTS studcoursess AS SELECT coursename, idnum, fname, mname, lname, sex  FROM course JOIN students WHERE course.courseNum = students.courseid')
